...
<?php 
$description = "The Heart of Texas Silhouette Association, also known as HOTSA, is a private, members only, rifle range and gun club located in the heart of Central Texas.";
...
<h2>Welcome</h2>
<p>The Heart of Texas Silhouette Association, also known as HOTSA, is a private, members only, rifle range and gun club located a little over an hour drive from either the Dallas/Ft. Worth area or Waco in the heart of Central Texas.</p>
...
<section class="featured background" id="featured">
<div class="featured-container">
<h2>Range Featured</h2>
<p>The Heart of Texas Silhouette Association's shooting range is featured in the background of The Legendary Shiloh Sharps Rifle Company's advertisement for their black powder rifles.</p>
</div><!-- .featured-container -->
</section><!-- #featured .featured .background -->
</section><!-- #main .cf -->
<!-- End Main Section -->
<!-- Include Footer File -->
